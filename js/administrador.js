...
(btnAgregar.style.display = "block") : (btnAgregar.style.display = "none")

usuarioLogeado?.admin === true ? 
(btnModificar.style.display = "block") : (btnModificar.style.display = "none")
...
const guardarProducto = () => {
    ...
    if(nombre !== "" && precio !== "" && imagen !== "" && categoria !== ""){
        ...
        alert("Completa todos los valores antes de continuar")
    }
